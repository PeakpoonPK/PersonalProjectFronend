    ...
    return (
        <div className='w-[75%] bg-slate-50 lg:pt-24 pt-32 h-screen absolute right-0 justify-center items-center '>
            ...
            <form
                ...
                <button className='flex justify-cente absolute bottom-4 right-4 font-normal bg-primary-darker rounded-2xl text-white py-2 px-4 hover:cursor-pointer hover:bg-primary-main active:bg-primary-dark'>Edit Profile</button>
            </form>
        </div>
