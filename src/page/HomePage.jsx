        ...
        <div className='flex flex-col static m-auto justify-center items-center  h-screen w-screen -z-10 '>
            <div className='mlg:hidden'>
                <div className=' justify-center items-center  pt-24'>
                    <img src={homeImage} alt='homePageImage' className='bg-no-repeat bg-center ' />
                </div>

                <div className='flex  justify-center items-center '>
                    <div className='flex flex-col bg-semantic-lightCream w-screen justify-center items-center py-10' >
